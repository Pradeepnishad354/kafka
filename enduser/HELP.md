...
* The original package name 'com.enduser.' is invalid and this project uses 'com.enduser' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/docs/3.1.8/reference/htmlsingle/index.html#messaging.kafka)
